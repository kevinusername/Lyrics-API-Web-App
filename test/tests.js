describe('Lyrics search', () => {
  ...
  describe('API calls', () => {
      ...
      window.ApiService.searchLyrics.returns(
        Promise.resolve({
          result: {
            ...
            copyright: {
              notice: 'OCEAN MAN lyrics are property and copyright of their owners. Commercial use is not allowed.',
            ...
            items: [
              {
                album: {
                  ...
                  external_urls: {
                    spotify: 'https://open.spotify.com/album/1yfJqxKKXG320vhqLfUEeC'
                  },
                  href: 'https://api.spotify.com/v1/albums/1yfJqxKKXG320vhqLfUEeC',
                  id: '1yfJqxKKXG320vhqLfUEeC',
                  images: [
                    {
                      height: 640,
                      url: 'https://i.scdn.co/image/ba1569338bcef61523f77c74d6f38b701b3266c7',
                      width: 640
                    },
                    {
                      height: 300,
                      url: 'https://i.scdn.co/image/4a3fcbe20ab3af2fb0c6d678b52497d08d45844a',
                      width: 300
                    },
                    {
                      height: 64,
                      url: 'https://i.scdn.co/image/41027f4ae3cea54fe3678f92e14febc33edb9a2b',
                      width: 64
                    }
                  ],
                  name: 'The Mollusk',
                ...
                external_urls: {
                  spotify: 'https://open.spotify.com/track/6M14BiCN00nOsba4JaYsHW'
                },
          ...
          tracks: [
            {
              album: {
                ...
                external_urls: {
                  spotify: 'https://open.spotify.com/album/6H5fUQk4FkT9iR4SNHnK3D'
                },
                ...
                images: [
                  {
                    height: 640,
                    url: 'https://i.scdn.co/image/3138592a50938d1ae316eb55a176f7b86d921eec',
                    width: 640
                  },
                  {
                    height: 300,
                    url: 'https://i.scdn.co/image/5d38203c0bd9106c2b82e82e9717fd849a561d17',
                    width: 300
                  },
                  {
                    height: 64,
                    url: 'https://i.scdn.co/image/2ee68bae2c5eab649afc2a93ebda33041b0ff273',
                    width: 64
                  }
                ],
              ...
              external_urls: {
                spotify: 'https://open.spotify.com/track/1fxyunx4FdwnbCXjWl9RhQ'
              },
            ...
            },
            {
              album: {
                ...
                external_urls: {
                  spotify: 'https://open.spotify.com/album/3U0p9Fjv2QN72aL4hT1fwe'
                },
                ...
                images: [
                  {
                    height: 640,
                    url: 'https://i.scdn.co/image/1c9bc1e273b5d9213da6418b860c5887c419f43c',
                    width: 640
                  },
                  {
                    height: 300,
                    url: 'https://i.scdn.co/image/180e47bbf379364bb244a25aeb7ed3ee7a62c329',
                    width: 300
                  },
                  {
                    height: 64,
                    url: 'https://i.scdn.co/image/da592e9a7c3920bbd18a246cdc600bdefd7481bb',
                    width: 64
                  }
                ],
              ...
              external_urls: {
                spotify: 'https://open.spotify.com/track/0zf9xqwYkkaBsg9we31bhi'
              },
            ...
            },
            {
              album: {
                ...
                artists: [
                  ...
                  },
                  {
                    ...
                    href: 'https://api.spotify.com/v1/artists/3P2gYnypDVi90ZavnaAhfL',
                ...
                external_urls: {
                  spotify: 'https://open.spotify.com/album/6qfS5de8GAy1G5tk7tyiof'
                },
                ...
                images: [
                  {
                    height: 640,
                    url: 'https://i.scdn.co/image/bb7ca0bdc1bbffbe9e654ecad92468c82d18dfde',
                    width: 640
                  },
                  {
                    height: 300,
                    url: 'https://i.scdn.co/image/be1177c62f2dcca8a74db1ad95721d4f307e391c',
                    width: 300
                  },
                  {
                    height: 64,
                    url: 'https://i.scdn.co/image/576daa9b149516b81cdd3bc7696a21bcb5a43278',
                    width: 64
                  }
                ],
                name: 'Freak Out!',
              ...
              external_urls: {
                spotify: 'https://open.spotify.com/track/2j25bv2cpByJLaNZRKEBwR'
              },
    ...
    it('should trigger a Lyrics search when the search button is clicked', () =>
      expect(window.ApiService.searchLyrics.calledWith($('artist-name').val(), $('song-name').val())))

    it('should populate the lyric container when search results arrive', done =>
      setTimeout(() => {
        expect($('#lyrics-body').text().length).toBeGreaterThan(0)
        done()
      }, FETCH_COMPLETION_DELAY))

    it('should populate the header container when search results arrive', done =>
      setTimeout(() => {
        expect($('#track-info').children().length).toBe(2)
        done()
      }, FETCH_COMPLETION_DELAY))

    it('should should display album art from spotify', done =>
      setTimeout(() => {
        expect(
          $('#album-art')
            .find($('img'))
    ...
    it('should display recommendations', done =>
      setTimeout(() => {
        expect($('#recommendations').children().length).toBe(4)
        done()
      }, FETCH_COMPLETION_DELAY))

    it('should load new search upon clicking recommendation', done =>
      setTimeout(() => {
        $('#rec0').click()
  ...
  describe('failed API calls', () => {
    ...
    it('should display an alert when the API call fails', done =>
      setTimeout(() => {
